...
public class TestRectangle {
	...
	public void testKopiKonstruktor(Rectangle r) {
		...
		assertNotSame(r.getP1(),rec.getP1(), "should not point to same Object");
		assertNotSame(r.getP2(),rec.getP2(), "should not point to same Object");
	}
	...
	void getWidth(Rectangle r, int w) {
		assertEquals(w, r.getWidth()); 
	}
	@ParameterizedTest
	@MethodSource("recArray5")
	void getHeight(Rectangle r, int h) {
	...
	@ParameterizedTest
	@MethodSource("recArray2")
	public void testClone(Rectangle r) {
		rec = new Rectangle(r);
		Rectangle rec2 = (Rectangle)rec.clone();
		assertEquals(rec, rec2);
		assertNotSame(rec,rec2, "should not point to same Object");
		assertNotSame(rec.getP1(),rec2.getP1(), "should not point to same Object");
		assertNotSame(rec.getP2(),rec2.getP2(), "should not point to same Object");
	}
}